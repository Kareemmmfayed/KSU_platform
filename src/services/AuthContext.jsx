...
const AuthProvider = ({ children }) => {
    ...
    const storedUserType = isLocalStorageAvailable ? localStorage.getItem('userType') : null;
    const storedToken = isLocalStorageAvailable ? localStorage.getItem('token') : null;
